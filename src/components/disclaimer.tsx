    ...
    <Modal>
      ...
      >
        <Modal.Container className="max-w-3xl">
          <Modal.Dialog className="dark:bg-[#19172c]">
            <Modal.Header>
            ...
            <Modal.Body>
              <p className="mb-4 text-gray-700 dark:text-gray-300">
                本網站為
                <span className="text-red-600">非官方</span>
                課程查詢工具，
              ...
              <ul className="mb-4 text-gray-700 dark:text-gray-300 list-disc list-inside space-y-1">
